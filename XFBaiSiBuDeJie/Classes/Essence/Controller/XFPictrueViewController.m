...
-(void)getNewData {
    ...
    @weakify(self)
    [self.tool getDataWithArrayType:TopicTypePicture block:^(id json, NSString *maxtime) {
        @strongify(self)
...
-(void)getMoreData {
    ...
    @weakify(self)
    [self.tool getDataWithMaxtime:self.maxtime page:@(page) TopicType:TopicTypePicture block:^(id json,NSString *maxtime) {
        @strongify(self)
