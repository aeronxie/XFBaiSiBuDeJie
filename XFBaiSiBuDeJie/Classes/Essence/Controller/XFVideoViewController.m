...
-(void)getNewData {
    ...
    @weakify(self)
    [self.tool getTalkDataWithArrayType:TopicTypeVideo block:^(id json, NSString *maxtime) {
        @strongify(self)
...
-(void)getMoreData {
    ...
    @weakify(self)
    [self.tool getTalkDataWithMaxtime:self.maxtime page:@(page) TopicType:TopicTypeVideo block:^(id json,NSString *maxtime) {
        @strongify(self)
