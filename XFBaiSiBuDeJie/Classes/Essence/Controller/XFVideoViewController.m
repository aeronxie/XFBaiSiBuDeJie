...
-(void)getNewData {
    ...
    @weakify(self)
    [self.tool getDataWithArrayType:TopicTypeVideo block:^(id json, NSString *maxtime) {
        @strongify(self)
...
-(void)getMoreData {
    ...
    @weakify(self)
    [self.tool getDataWithMaxtime:self.maxtime page:@(page) TopicType:TopicTypeVideo block:^(id json,NSString *maxtime) {
        @strongify(self)
